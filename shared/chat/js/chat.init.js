...
document.querySelectorAll(".chat-user-list li a").forEach(function(e) {
    e.addEventListener("click", function(e) {
        userChatElement.forEach(function(e) { e.classList.add("user-chat-show") });
        var t = document.querySelector(".chat-user-list li.active");
        t && t.classList.remove("active"), this.parentNode.classList.add("active")
    })
}), document.querySelectorAll(".user-chat-remove").forEach(function(e) { e.addEventListener("click", function(e) { userChatElement.forEach(function(e) { e.classList.remove("user-chat-show") }) }) });
...
chatForm && chatForm.addEventListener("submit", function(e) {
    ...
    var t = currentChatId,
        s = currentChatId,
        e = chatInput.value;
    0 === e.length ? (chatInputfeedback.classList.add("show"), setTimeout(function() { chatInputfeedback.classList.remove("show") }, 2e3)) : (1 == isreplyMessage ? (getReplyChatList(s, e), isreplyMessage = !1) : getChatList(t, e), scrollToBottom(t || s)), chatInput.value = "", document.getElementById("close_toggle").click()
    ...
    s.addEventListener("click", function() {
        ...
        document.querySelector(".user-chat-topbar .text-truncate .username").innerHTML = e, document.querySelector(".profile-offcanvas .username").innerHTML = e, t ? (document.querySelector(".user-chat-topbar .avatar-xs").setAttribute("src", t), document.querySelector(".profile-offcanvas .avatar-lg").setAttribute("src", t)) : (document.querySelector(".user-chat-topbar .avatar-xs").setAttribute("src", dummyUserImage), document.querySelector(".profile-offcanvas .avatar-lg").setAttribute("src", dummyUserImage)), document.getElementById("users-conversation").querySelectorAll(".left .chat-avatar").forEach(function(e) { t ? e.querySelector("img").setAttribute("src", t) : e.querySelector("img").setAttribute("src", dummyUserImage) })
    })
}), document.querySelectorAll("#channelList li").forEach(function(t) {
    t.addEventListener("click", function() {
        var e = t.querySelector(".text-truncate").innerHTML;
        document.querySelector(".user-chat-topbar .text-truncate .username").innerHTML = e, document.querySelector(".profile-offcanvas .username").innerHTML = e, document.querySelector(".user-chat-topbar .avatar-xs").setAttribute("src", dummyMultiUserImage), document.querySelector(".profile-offcanvas .avatar-lg").setAttribute("src", dummyMultiUserImage), document.getElementById("users-conversation").querySelectorAll(".left .chat-avatar").forEach(function(e) { e.querySelector("img").setAttribute("src", dummyUserImage) })
    })
});
...
}), document.getElementById("copyClipBoard");
var copyClipboardAlert = document.querySelectorAll(".copy-message");
copyClipboardAlert.forEach(function(e) { e.addEventListener("click", function() { document.getElementById("copyClipBoard").style.display = "block", setTimeout(function() { document.getElementById("copyClipBoard").style.display = "none" }, 1e3) }) });
...
replyMessage.forEach(function(t) {
    t.addEventListener("click", function() {
        isreplyMessage = !0, replyToggleOpen.classList.add("show"), replyToggleClose.addEventListener("click", function() { replyToggleOpen.classList.remove("show") });
...
var getChatList = function(e, t) {
        ...
        r.querySelectorAll(".delete-item").forEach(function(e) { e.addEventListener("click", function() { s.removeChild(r) }) }), r.querySelectorAll(".copy-message").forEach(function(e) {
            e.addEventListener("click", function() {
                var e = r.childNodes[1].firstElementChild.firstElementChild.firstElementChild.firstElementChild.innerText;
                navigator.clipboard.writeText(e)
            })
        }), r.querySelectorAll(".copy-message").forEach(function(e) { e.addEventListener("click", function() { document.getElementById("copyClipBoard").style.display = "block", setTimeout(function() { document.getElementById("copyClipBoard").style.display = "none" }, 1e3) }) }), r.querySelectorAll(".reply-message").forEach(function(n) {
            n.addEventListener("click", function() {
                ...
                isreplyMessage = !0, e.classList.add("show"), t.addEventListener("click", function() { e.classList.remove("show") });
    ...
    getReplyChatList = function(e, t) {
        ...
        n.querySelectorAll(".delete-item").forEach(function(e) { e.addEventListener("click", function() { itemList.removeChild(n) }) }), n.querySelectorAll(".copy-message").forEach(function(e) { e.addEventListener("click", function() { document.getElementById("copyClipBoard").style.display = "block", document.getElementById("copyClipBoardChannel").style.display = "block", setTimeout(function() { document.getElementById("copyClipBoard").style.display = "none", document.getElementById("copyClipBoardChannel").style.display = "none" }, 1e3) }) }), n.querySelectorAll(".reply-message").forEach(function(s) {
            s.addEventListener("click", function() {
        ...
        }), n.querySelectorAll(".copy-message").forEach(function(e) { e.addEventListener("click", function() { n.childNodes[1].children[1].firstElementChild.firstElementChild.getAttribute("id"), isText = n.childNodes[1].children[1].firstElementChild.firstElementChild.innerText, navigator.clipboard.writeText(isText) }) })
    }